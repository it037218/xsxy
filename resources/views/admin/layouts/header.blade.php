...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        <div class="layui-logo">
            <img src="https://pro.modao.cc/uploads3/images/2172/21721796/raw_1529485671.png" style="height: 60px">
        </div>
        <div style="color: rgb(0, 150, 136); font-size: 28px;height: 60px;line-height: 60px;padding-left: 200px;font-weight: bold">
            图书
        </div>
